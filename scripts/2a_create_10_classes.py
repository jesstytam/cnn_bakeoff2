...
train_labels_dir = '/media/jess/DATA/PhD/data/ecoflow/yolo_labels/10_classes/train/labels/'
test_labels_dir = '/media/jess/DATA/PhD/data/ecoflow/yolo_labels/10_classes/test/labels/'
random.seed(42)
...
train_images_dir = '/media/jess/DATA/PhD/data/ecoflow/yolo_labels/10_classes/train/images/'
test_images_dir = '/media/jess/DATA/PhD/data/ecoflow/yolo_labels/10_classes/test/images/'
